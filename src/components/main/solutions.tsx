...
export default function Solutions() {
    ...
    return (
        <Container>
            <div className='flex items-center justify-center gap-5' id='solutions'>
                <Image src={"https://i.imgur.com/sXfjmCx.png"} alt='Solutions Image' width={574} height={700} quality={100} />
                <div>
                    <h1 className='text-5xl font-bold leading-tight'>Soluções atingindo o <span className='bg-gradient-to-r from-[#4B0082] to-[#4682B4] bg-clip-text text-transparent'>MÁXIMO</span></h1>
